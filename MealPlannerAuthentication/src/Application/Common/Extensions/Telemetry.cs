...
namespace invensys.iserve.Application.Common.Extensions;
...
public static class Telemetry
{
   ...
   public static class Metrics
   {
      ...
      private static readonly Counter<long> ConsentGrantedCounter = Meter.CreateCounter<long>(Counters.ConsentGranted);
      ...
      private static readonly Counter<long> ConsentDeniedCounter = Meter.CreateCounter<long>(Counters.ConsentDenied);
      ...
      private static readonly Counter<long> UserLoginFailureCounter = Meter.CreateCounter<long>(Counters.UserLoginFailure);
